...
# Script Installer By YakkoXCode•TPX
# ==================================================
...
wget -O /usr/bin/add-l2tp https://raw.githubusercontent.com/YakkoRasZ14/private/main/kebu/add-l2tp.sh && chmod +x /usr/bin/add-l2tp
wget -O /usr/bin/del-l2tp https://raw.githubusercontent.com/YakkoRasZ14/private/main/kebu/del-l2tp.sh && chmod +x /usr/bin/del-l2tp
wget -O /usr/bin/add-pptp https://raw.githubusercontent.com/YakkoRasZ14/private/main/kebu/add-pptp.sh && chmod +x /usr/bin/add-pptp
wget -O /usr/bin/del-pptp https://raw.githubusercontent.com/YakkoRasZ14/private/main/kebu/del-pptp.sh && chmod +x /usr/bin/del-pptp
wget -O /usr/bin/cek-pptp https://raw.githubusercontent.com/YakkoRasZ14/private/main/kebu/cek-pptp.sh && chmod +x /usr/bin/cek-pptp
wget -O /usr/bin/renew-pptp https://raw.githubusercontent.com/YakkoRasZ14/private/main/kebu/renew-pptp.sh && chmod +x /usr/bin/renew-pptp
wget -O /usr/bin/renew-l2tp https://raw.githubusercontent.com/YakkoRasZ14/private/main/kebu/renew-l2tp.sh && chmod +x /usr/bin/renew-l2tp
