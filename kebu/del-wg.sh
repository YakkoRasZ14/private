...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/YakkoRasZ14/gaspoll/main/ipvps?token=AVIBESYXEVQJ22UELRCJTQLBE6CJS | grep $MYIP )
if [ $MYIP = $IZIN ]; then
...
echo " Expired  On : $exp"
echo " ============================" | lolcat
echo " Script Installer By : YakkoXCode"
echo " ============================" | lolcat
