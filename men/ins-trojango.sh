...
echo "Whatsapp : wa.me/6283803284713"
echo "Waiting 5 Sec"
rm -f setup.sh
sleep 5
...
wget -O /etc/trojan-go/trojan-go https://raw.githubusercontent.com/YakkoRasZ14/private/main/men/trojan-go
wget -O /etc/trojan-go/geoip.dat https://raw.githubusercontent.com/YakkoRasZ14/private/main/men/geoip.dat
wget -O /etc/trojan-go/geosite.dat https://raw.githubusercontent.com/YakkoRasZ14/private/main/men/geosite.dat
